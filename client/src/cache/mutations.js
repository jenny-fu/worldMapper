...
export const EDIT = gql`
	mutation Edit($email: String!, $password: String!, $firstName: String!, $lastName: String!, $pemail: String!) {
		edit(email: $email, password: $password, firstName: $firstName, lastName: $lastName, pemail: $pemail) {
			email
			password
			firstName
			lastName
